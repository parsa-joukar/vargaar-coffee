...
<html>
    <head>
        <link rel="shortcut icon" type="image/png" href="resourses/css/img/vargarr-png.png" />
        <link rel="stylesheet" type="text/css" href="resourses/css/style.css" />
        <link rel="stylesheet" type="text/css" href="resourses/css/media.css" />
        <link rel="stylesheet" type="text/css" href="resourses/css/fonts/web-font/css/fontiran.css" />
        <meta name="description" content="ورگار یکی از وارد کنندگان مستقیم قهوه می باشد.خرید انواع دانه قهوه سبز و رست شده با بالاترین کیفیت امکان پذیر میباشد" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta charset="UTF-8" />
        <meta http-equiv="X-UA-compatible" content="ie=edge" />
        <title>vargar coffee store فروشگاه خرید قهوه ورگار</title>
    </head>
    <body>
        <div class="mobile-navi">
            <ul class="mob__ul">
                <li class="nav__main--ul--li"><a onclick="fader()" class="top-head--a nav__main--ul--a" href="products.html">محصولات</a></li>
                <li class="nav__main--ul--li"><a onclick="fader()" class="top-head--a nav__main--ul--a" href="#why-us">درباره ما</a></li>
                <li class="nav__main--ul--li"><a onclick="fader()" class="top-head--a nav__main--ul--a" href="#contact">تماس با ما</a></li>
                <li class="nav__main--ul--li"><a onclick="fader()" class="top-head--a nav__main--ul--a" href="index.php">خانه</a></li>
            </ul>
        </div>
        <div class="text-us">
            <div class="text-container">
                <svg class="text-us--icon text-us--wp" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                    <path
                ...
                <svg class="text-us--icon text-us--cancel" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.001 512.001" style="enable-background: new 0 0 512.001 512.001;" xml:space="preserve">
                    <g>
                        <g>
                            <path
            ...
            <div class="wp-container">
                <div class="top-wp">
                    ...
                    <div class="name-wp">
                        <h2>مسیح ابونجمی</h2>
                        <h4>پاسخگو شما در همه ساعات شبانه روز</h4>
                    </div>
                    <div class="leave-wp">
                        <svg
                            class="text-us--icon text-us--cancel"
                ...
                <div class="middle-wp">
                    <div class="name-wp">
                        <h2>مسیح ابونجمی</h2>
                        <h4>سلام . ایا به کمک نیاز دارید؟</h4>
                    </div>
                    <span>
                ...
                <div class="bot-wp">
                    <a href="https://api.whatsapp.com/send?phone=989925402149&text=سلام . من نیاز به کمک دارم" target="_blank" class="wp-link">
                        <svg class="nav__icons--image" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                            <path
                                d="m17.507 14.307-.009.075c-2.199-1.096-2.429-1.242-2.713-.816-.197.295-.771.964-.944 1.162-.175.195-.349.21-.646.075-.3-.15-1.263-.465-2.403-1.485-.888-.795-1.484-1.77-1.66-2.07-.293-.506.32-.578.878-1.634.1-.21.049-.375-.025-.524-.075-.15-.672-1.62-.922-2.206-.24-.584-.487-.51-.672-.51-.576-.05-.997-.042-1.368.344-1.614 1.774-1.207 3.604.174 5.55 2.714 3.552 4.16 4.206 6.804 5.114.714.227 1.365.195 1.88.121.574-.091 1.767-.721 2.016-1.426.255-.705.255-1.29.18-1.425-.074-.135-.27-.21-.57-.345z"
                            />
                            <path
        ...
        <main class="container">
            <header class="header">
                <div class="header-container">
                    <div class="left-bar">
                        <div class="nav__logo">
                            <a href="index.php"><img class="nav__logo--image" alt="vargar logo" src="resourses/css/img/vargarr-png.png" /></a>
                        </div>
                    </div>
                    <div class="right-bar">
                        <div class="nav__main">
                            <ul class="nav__main--ul">
                                <li class="nav__main--ul--li"><a class="top-head--a nav__main--ul--a" href="products.html">محصولات</a></li>
                                <li class="nav__main--ul--li"><a class="top-head--a nav__main--ul--a" href="#why-us">درباره ما</a></li>
                                <li class="nav__main--ul--li"><a class="top-head--a nav__main--ul--a" href="#contact">تماس با ما</a></li>
                                <li class="nav__main--ul--li"><a class="top-head--a nav__main--ul--a" href="index.php">خانه</a></li>
                            </ul>
                        </div>
                        <div class="heading-primary">
                            <h1>
                                ،ورگار‌ <br />
                                <span>.</span>بهترین گزینه برای شروع روز
                            </h1>
                            <h3>
                                <span class="coffee-span"> قهوه </span><span> یکی </span><span> از </span><span> پر </span><span> استفاده </span><span> ترین </span><span> نوشیدنی های </span><span> جهان </span><span> می باشد </span>
                                <span> . </span><span> ما </span><span> در </span><span> ورگار </span><span> کوشیده ایم </span><span> تا </span><span> این </span><span> نوشیدنی </span><span> پرطرفدار </span><span> را </span>
                                <span> با </span><span> بهترین </span><span> کیفیت </span><span> به </span><span> شما </span><span> عرضه </span><span> کنیم </span><span> . </span><span class="unvisible"> م </span>
                            </h3>
                        </div>
                    </div>
                    <a href="products.html" class="coffee-bar"> <img src="resourses/css/img/coffees/coffee-bar.png" alt="coffee-bag" class="coffee-bar--img" /> </a>
                </div>
                <div class="nav-mob-container"><div class="nav-mobile"></div></div>
            </header>
            <section class="story">
                <div class="heading-secondary top-story"><h2 class="heading-secondary--text">داستان قهوه</h2></div>
                <div class="story-con">
                    <div class="container-s a">
                        <div class="left-s">
                            <div class="text-container">
                                <h2 class="story-heading">مزرعه ما</h2>
                                <p class="story-content">
                                    بر آنیم تا به پاس همراهی و همدلی شما عزیزان بهترین کیفیت ممکن را تقدیمتان کنیم لذا همواره در انتخاب مزرعه قهوه حساسیت های لازم را نسبت به محصولات آن مزرعه و آن کشاورز را به خرج داده ایم هم اینک مفتخریم که
                                    لیستی از بهترین مزارع کشت قهوه را در اختیار داریم و در فصل های برداشت خاص آن مزارع نسبت به تهیه مرغوب ترین قهوه ها اقدام میکنیم
                                </p>
                            </div>
                        </div>
                        <div class="right-s"></div>
                    </div>
                    <div class="container-s b">
                        <div class="right-s"></div>
                        <div class="left-s">
                            <div class="text-container">
                                <h2 class="story-heading">قهوه سبز</h2>
                                <p class="story-content">
                                    ما در فصل برداشت خاص هر کشور اقدام به تماس با مزارع مورد نظر خواهیم کرد و از محصول آن سالشان میپرسیم که چگونه بوده است پس از بررسی های آنلاین، مقداری از دان سبز مورد نظر را به عنوان نمونه دریافت میکنیم که
                                    این نمونه ها در آزمایشگاه مورد آزمایش قرار میگیرند تا از کیفیت آن مطمئن شویم و پس از انجام آزمایشات متعدد و دریافت نتایج مطلوب اقدام به خرید دان سبز از کشور مبدا خواهیم کرد اینگونه همیشه دان سبزهایی با
                                    کیفیت و تازه را در دست داریم
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="container-s c">
                        <div class="left-s">
                            <div class="text-container">
                                <h2 class="story-heading">قهوه رست شده</h2>
                                <p class="story-content">
                                    عمل برشته کاری یکی از حساس ترین بخش های فرآوری قهوه میباشد ما در ورگار کافی کوشیده ایم تا با استفاده از بروز ترین دستگاه های اتوماتیک دنیا و با اتکا به تجربه و دانش در این زمینه، لذت نوشیدن قهوه ای دلنشین
                                    را تقدیمتان کنیم
                                </p>
                            </div>
                        </div>
            ...
            <section class="products" id="products">
                <div class="demo-products">
                    <a class="demo-products__image" href="#"><img src="resourses/css/img/coffees/kenesht-final.jpg" alt="product image 1" class="demo-products__image" /></a> <a href="#" class="demo-products__name">Kenesht Coffee</a>
                    <div class="demo-products__location">
                        <a class="demo-products__icon" href="#">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="top-head--icon"
                                xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <div class="demo-products__weight">
                        <a class="demo-products__icon" href="#">
                            ...
                            >
                                <g>
                                    <path
                                        d="M483,243.1c-18.1-12.9-41.5-16.2-62.5-8.9l-4,1.4c-1.6-10.9-11-19.3-22.3-19.3h-72.4c-4.1,0-7.5,3.4-7.5,7.5 s3.4,7.5,7.5,7.5h72.4c4.1,0,7.5,3.4,7.5,7.5v52c0,86.2-70.2,156.4-156.4,156.4h-31.9c-40.9,0-79.7-15.7-109-44.2 c-3-2.9-7.7-2.8-10.6,0.1c-2.9,3-2.8,7.7,0.1,10.6c14.5,14.1,31.2,25.4,49.2,33.5H7.5c-4.1,0-7.5,3.4-7.5,7.5 c0,26.2,21.3,47.5,47.5,47.5h363.4c4.1,0,7.5-3.4,7.5-7.5s-3.4-7.5-7.5-7.5H47.5c-15.3,0-28.2-10.7-31.6-25H443 c-1.4,5.8-4.3,11.2-8.7,15.5c-6.1,6.1-14.3,9.5-23,9.5h-37.2c-4.1,0-7.5,3.4-7.5,7.5s3.4,7.5,7.5,7.5h37.2 c12.7,0,24.6-4.9,33.6-13.9c9-9,13.9-20.9,13.9-33.6c0-4.1-3.4-7.5-7.5-7.5H315.5c24.5-11,46-27.7,62.8-48.3 c13.9,8.7,30.1,13.5,46.5,13.5c14.7,0,29.2-3.8,42.1-10.9c27.8-15.3,45.1-44.6,45.1-76.3v-26C512,277,501.2,256,483,243.1 L483,243.1z M416.8,290.8v-4.5l19.5-6.8c6.5-2.3,13.4-1.3,19,2.7c5.6,4,8.8,10.2,8.8,17v26c0,14.3-7.8,27.5-20.3,34.4 c-12.9,7.1-28.6,6.4-40.7-1.7C411.9,337.3,416.8,314.6,416.8,290.8L416.8,290.8z M497,325.2c0,26.3-14.3,50.5-37.3,63.2 c-10.7,5.9-22.7,9-34.9,9c-13.4,0-26.2-3.6-37.5-10.6c3.4-4.9,6.4-10.1,9.3-15.3c8.6,5.3,18.4,8,28.3,8c9,0,18-2.2,26.2-6.8 c17.3-9.6,28-27.8,28-47.5v-26c0-11.8-5.5-22.4-15.1-29.3c-9.6-6.8-21.5-8.5-32.6-4.6l-14.6,5.1v-19l8.7-3 c16.4-5.7,34.7-3.1,48.9,7c14.2,10.1,22.6,26.5,22.6,43.9V325.2z"
                                    />
                                    <path
                                        d="M54.3,350.2c4.3,10.1,9.8,20,16.3,29.3c1.6,2.3,4.5,3.6,7.4,3.6c1.5,0,3.1-0.4,4.5-1.1c4.1-2.1,5.4-6.8,2.9-10.3 c-5.9-8.5-10.9-17.5-14.9-26.7c-2.7-6.3-4.9-12.9-6.7-19.5c-3-11.3-4.5-23-4.5-34.7v-52c0-4.1,3.9-7.5,8.6-7.5h259 c4.8,0,8.6-3.4,8.6-7.5s-3.9-7.5-8.6-7.5H68c-14.3,0-25.9,10.1-25.9,22.5v52c0,12.8,1.6,25.6,4.9,38 C48.9,336,51.3,343.2,54.3,350.2L54.3,350.2z"
                                    />
                                    <path
                                        d="M219.8,177c-2.3,3.4-1.4,8.1,2,10.4c1.3,0.9,2.8,1.3,4.2,1.3c2.4,0,4.8-1.2,6.2-3.3c33.5-49.3,14.6-73.8-0.7-93.4 c-14.6-18.8-26.1-33.6,0.5-70.3c2.4-3.4,1.7-8-1.7-10.5c-3.4-2.4-8-1.7-10.5,1.7c-33.2,45.8-15.7,68.3-0.3,88.3 C234.4,120.2,247.2,136.6,219.8,177L219.8,177z"
                                    />
                                    <path
                                        d="M140.6,144.3c-2.6,3.2-2.1,7.9,1.1,10.6c1.4,1.1,3.1,1.7,4.7,1.7c2.2,0,4.3-0.9,5.8-2.8c26.4-32.3,10.8-49-0.6-61.2 c-10.6-11.3-17-18.2,0.5-38.1c2.7-3.1,2.4-7.9-0.7-10.6c-3.1-2.7-7.9-2.4-10.6,0.7c-26.3,30.1-11.2,46.4-0.1,58.2 C151.5,114.4,158.7,122.1,140.6,144.3L140.6,144.3z"
                                    />
                                    <path
                                        d="M299.8,144.3c-2.6,3.2-2.1,7.9,1.1,10.6c1.4,1.1,3.1,1.7,4.7,1.7c2.2,0,4.3-0.9,5.8-2.8c26.4-32.3,10.8-49-0.6-61.2 c-10.6-11.3-17-18.2,0.5-38.1c2.7-3.1,2.4-7.9-0.7-10.6c-3.1-2.7-7.9-2.4-10.6,0.7c-26.3,30.1-11.2,46.4-0.1,58.2 C310.7,114.4,317.9,122.1,299.8,144.3z"
                                    />
                                </g>
                                <path
                                    d="M182,341.2c1.1,1.5,2.8,2.4,4.7,2.4h25.9l-25.4,55.9c-1.2,2.6-0.3,5.6,2,7.2c1,0.7,2.2,1,3.3,1c1.5,0,3-0.6,4.1-1.7 l87.5-87.5c1.7-1.7,2.2-4.2,1.3-6.4c-0.9-2.2-3-3.6-5.4-3.6h-35.8l29-43.4c1.2-1.8,1.3-4.1,0.3-6c-1-1.9-3-3.1-5.1-3.1H210 c-2.6,0-4.8,1.7-5.6,4.1L181.1,336C180.6,337.7,180.9,339.7,182,341.2z M214.3,267.7h43.1l-29,43.4c-1.2,1.8-1.3,4.1-0.3,6 c1,1.9,3,3.1,5.1,3.1H266L211.1,375l15.9-34.9c0.8-1.8,0.7-3.9-0.4-5.6c-1.1-1.7-2.9-2.7-4.9-2.7h-27.1L214.3,267.7z"
                                />
                            </svg>
                        </a>
                        <p>full caffeine</p>
                    </div>
                    <div class="demo-products__price">
                        <a class="demo-products__icon" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 46 60" class="top-head--icon">
                                <g id="Page-1">
                                    <g>
                                        <path
                                            d="m22.761 36.277c-4.528-4.528-11.071-5.377-14.588-1.883-1.45258847 1.4955115-2.23666054 3.5161298-2.173 5.6.12771821 3.4005457 1.5869675 6.6146294 4.063 8.949 2.3578601 2.4689732 5.588065 3.9175406 9 4.036 2.0761043.0577573 4.0890187-.7175208 5.59-2.153 1.4522232-1.4956761 2.2359266-3.5162743 2.172-5.6-.1279805-3.4006907-1.5875985-6.6147953-4.064-8.949zm-11.284 11.252c-2.0884974-1.9697008-3.33438479-4.6707359-3.477-7.538-.00876933-.7867861.12470855-1.5686819.394-2.308.87302369.5172164 1.8518301.8300378 2.863.915 2.2459227.1167648 4.0422962 1.9083939 4.165 4.154.2513943 3.1246298 2.7358197 5.6035446 5.861 5.848.7375145.0489678 1.454087.2658207 2.095.634-.05.055-.087.121-.139.173-2.734 2.718-8.011 1.873-11.762-1.878zm12.952.008c-.8728082-.5175355-1.8517671-.8300638-2.863-.914-2.246674-.1163178-4.0437426-1.9086414-4.166-4.155-.249583-3.1254373-2.734141-5.6057555-5.86-5.85-.7375247-.0496578-1.4540175-.2668287-2.095-.635.05-.055.086-.121.139-.173 1.126325-1.0695858 2.6345992-1.6427084 4.187-1.591 2.880732.1319455 5.5975216 1.3779326 7.577 3.475 2.0872668 1.9694535 3.3320772 4.6697677 3.474 7.536.0090789.7863983-.1240614 1.5679623-.393 2.307z"
                                        />
                                        <path
                                            d="m21.55 33c.2330673.127322.507209.1567037.7619647.0816652.2547557-.0750386.4691989-.2483333.5960353-.4816652 1.6-2.918 4.043-4.6 6.7-4.605.1593333 0 .3213333.007.486.021-.2023659.9480934-.6456152 1.8280484-1.287 2.555-2.3535365 2.7384686-2.3535365 6.7855314 0 9.524.8907601.9737504 1.3786287 2.249357 1.365 3.569.0191335 1.3149989-.4685782 2.5869167-1.362 3.552-1.1123124 1.2681845-1.7394025 2.8894074-1.77 4.576-.0128703.4730659.3076293.8903831.768 1 .5895998.1404207 1.1939199.2095818 1.8.206 5.74-.01 10.4-6.067 10.391-13.5.01-6.587-3.608-12.18-8.6-13.3-.5906762-.1312603-1.1939153-.1976535-1.799-.198-3.359.01-6.518 2.12-8.45 5.643-.1270046.2329726-.1562108.50687-.0811879.7613852.0750229.2545151.2481234.468779.4811879.5956148zm10.489-4.5c3.472 1.455 5.969 5.943 5.961 11 .008 6.332-3.757 11.491-8.393 11.5-.165 0-.325-.006-.482-.018.2010738-.9497375.6444388-1.8313001 1.287-2.559 2.3526874-2.7387833 2.3526874-6.7852167 0-9.524-.8918171-.973169-1.3801587-2.2490775-1.366-3.569-.0191335-1.3149989.4685782-2.5869167 1.362-3.552.8041117-.9424769 1.3642122-2.0681725 1.631-3.278z"
                                        />
                                        <path
                                            d="m.916 31.605c-.42297669 2.3769019-.58493806 4.7929095-.483 7.205.1811918 7.3224913 3.82344401 14.1254185 9.817 18.336 3.7742561 2.519595 8.2120138 3.861016 12.75 3.854 9.5843717-.0392504 18.1535763-5.9802793 21.552-14.942.9466759-2.9311401 1.3823554-6.0032219 1.288-9.082-.1725904-4.3776791-1.2269757-8.6754897-3.1-12.636-2.7174525-5.7064452-6.0948609-11.0744536-10.063-15.994-.591-.76-1.189-1.595-1.8-2.444-1.0558284-1.53856618-2.2011348-3.0137743-3.43-4.418-.3837611-.4187705-.9711452-.58485027-1.5173693-.42902819-.5462241.15582207-.9575758.6068125-1.0626307 1.16502819-.1.521-.2 1.093-.311 1.7-.7 3.9-2.119 12.008-4.5 11.889-1.081-.06-1.437-1.733-1.766-3.778-.1281718-.8088091-.2119639-1.6240292-.251-2.442-.0307892-.67195635-.5065578-1.24060668-1.1625355-1.38949098-.6559777-.14888431-1.3306132.15866399-1.6484645.75149098-1.4427778 2.7814656-2.2476151 5.849481-2.356 8.981-.0651358 1.3943814-.0199953 2.7917298.135 4.179.2411065 1.2140829.0715393 2.4738758-.482 3.581-.1251073.1696995-.3178052.2766322-.528.293-.2221191.0334963-.4477352-.0323237-.617-.18-1.038-.851-1.3-3.87-1.392-4.859-.08832401-1.1036704-.11203114-2.2115616-.071-3.318.02636174-.6641743-.38752715-1.2664905-1.017-1.48-.62105664-.2117996-1.30748324.0094185-1.688.544-3.15067014 4.4342927-5.29526946 9.5029734-6.284 14.852-.005.02-.009.041-.012.061zm6.984-12.373c.01.6586667.04066667 1.2876667.092 1.887.212 2.4.63 5.011 2.116 6.231.5851132.4864865 1.344327.7113584 2.1.622.7379336-.074269 1.4138207-.4457903 1.872-1.029 1.166-1.451 1.025-4.017.911-5.053-.1432137-1.2820394-.1850102-2.5733829-.125-3.862.0883803-2.2046246.5401209-4.3795345 1.337-6.437.033.263.07.525.113.787.338 2.1.848 5.273 3.625 5.427 4.074.217 5.476-7.4 6.58-13.531.0406667-.22933333.081-.45266667.121-.67.887 1.063 1.76 2.279 2.609 3.464.624.87 1.239 1.727 1.845 2.506 3.8716581 4.7986175 7.1677922 10.0343055 9.821 15.6 1.7613228 3.7166754 2.754804 7.7504608 2.921 11.86.0890322 2.8351587-.3076918 5.6646498-1.173 8.366-3.1127646 8.1630609-10.9286467 13.5684002-19.665 13.6-4.1429215.0069288-8.1944382-1.217576-11.64-3.518-5.46432373-3.855503-8.77739034-10.0731607-8.93-16.759-.09560864-2.265138.05662851-4.5339411.454-6.766 0-.017.008-.034.011-.051.82963228-4.5095535 2.52961302-8.8143599 5.005-12.674z"
                                        />
                                    </g>
                                </g>
                            </svg>
                    ...
                    <a href="#popup" id="firstbtn" class="demo-products__btn">سفارش دهید</a>
                </div>
                <div class="demo-products">
                    <a class="demo-products__image" href="#"><img src="resourses/css/img/coffees/youtab-final.jpg" alt="product image 1" class="demo-products__image" /></a> <a href="#" class="demo-products__name">Youtab Coffee</a>
                    <div class="demo-products__location">
                        <a class="demo-products__icon" href="#">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="#popup" id="secondbtn" class="demo-products__btn">سفارش دهید</a>
                </div>
                <div class="demo-products">
                    <a class="demo-products__image" href="#"><img src="resourses/css/img/coffees/sargon-final.jpg" alt="product image 1" class="demo-products__image" /></a> <a href="#" class="demo-products__name">Sargon Coffee</a>
                    <div class="demo-products__location">
                        <a class="demo-products__icon" href="#">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="#popup" id="thirdbtn" class="demo-products__btn">سفارش دهید</a>
                </div>
                <div class="demo-products add-mob">
                    <a class="demo-products__image" href="#"><img src="resourses/css/img/coffees/vardan-final.jpg" alt="product image 1" class="demo-products__image" /></a> <a href="#" class="demo-products__name">Vardan Coffee</a>
                    <div class="demo-products__location">
                        <a class="demo-products__icon" href="#">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="#popup" id="forthbtn" class="demo-products__btn">سفارش دهید</a>
                </div>
                <a class="more" href="products.html">
                    <div class="mores"><div class="more__arrow">محصولات بیشتر</div></div>
                </a>
            </section>
            <section class="why-us" id="why-us">
                <div class="heading-secondary why-us__heading"><h2 class="heading-secondary--text">چرا ورگار</h2></div>
                <div class="why-us__container">
                    <a href="#" class="why-us__container--icon">
                        <svg xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" class="top-head--icon why-us--icon" viewBox="0 0 476 476" style="enable-background: new 0 0 476 476;" xml:space="preserve">
                            <g>
                                <path
                ...
                <div class="why-us__container">
                    ...
                    <h3 class="why-us__container--header">حذف واسته ها</h3>
                    <p class="why-us__container--text">جمله از مزرعه تا فنجان تلاش ما ورگاری ها بوده</p>
                </div>
                <div class="why-us__container">
                    <a class="why-us__container--icon" href="#">
                        <svg class="top-head--icon why-us--icon" id="Layer_1" enable-background="new 0 0 512.002 512.002" viewBox="0 0 512.002 512.002">
                            <g>
                                <g>
                                    <path
                                    ...
                                    <path
                                        d="m418.428 110 7.071-7.071c11.696-11.697 11.696-30.729 0-42.427-11.696-11.697-30.729-11.697-42.427 0l-7.071 7.071-7.071-7.071c-11.697-11.696-30.729-11.696-42.427 0-11.697 11.697-11.697 30.729 0 42.427l7.071 7.071-7.071 7.071c-11.697 11.697-11.697 30.73 0 42.427 5.849 5.848 13.531 8.772 21.213 8.772s15.365-2.924 21.213-8.772l7.071-7.071 7.071 7.071c11.697 11.696 30.729 11.697 42.427 0 11.697-11.697 11.697-30.73 0-42.427zm-7.071 35.355c-3.898 3.9-10.243 3.899-14.142 0l-14.142-14.142c-1.953-1.953-4.512-2.929-7.071-2.929s-5.119.976-7.071 2.929l-14.142 14.142c-1.873 1.873-4.384 2.905-7.071 2.905s-5.198-1.031-7.071-2.905c-1.874-1.873-2.905-4.384-2.905-7.071s1.032-5.198 2.905-7.071l14.142-14.142c3.905-3.905 3.905-10.237 0-14.143l-14.142-14.142c-3.899-3.899-3.899-10.243 0-14.142 3.898-3.899 10.243-3.899 14.142 0l14.142 14.142c3.905 3.905 10.237 3.905 14.143 0l14.142-14.142c3.9-3.899 10.244-3.899 14.143 0s3.899 10.244 0 14.142l-14.142 14.142c-3.905 3.905-3.905 10.237 0 14.143l14.142 14.142c3.897 3.899 3.897 10.244-.002 14.142z"
                                    />
                                    <path
                                        d="m77.432 129.716 25.902 25.902c5.666 5.666 13.199 8.786 21.212 8.786s15.546-3.121 21.212-8.786l48.812-48.812c11.695-11.696 11.695-30.727 0-42.423-5.666-5.666-13.199-8.786-21.212-8.786s-15.546 3.121-21.211 8.786l-27.601 27.6-4.69-4.69c-11.696-11.696-30.727-11.695-42.424 0-11.696 11.696-11.696 30.727 0 42.423zm14.142-28.281c1.95-1.949 4.509-2.924 7.07-2.924 2.56 0 5.121.975 7.069 2.924l11.761 11.761c3.905 3.905 10.237 3.905 14.143 0l34.671-34.671c1.888-1.889 4.399-2.928 7.069-2.928s5.181 1.04 7.069 2.928c3.898 3.898 3.898 10.241 0 14.139l-48.812 48.812c-1.888 1.888-4.398 2.928-7.069 2.928-2.67 0-5.181-1.04-7.069-2.928l-25.902-25.902c-3.898-3.899-3.898-10.241 0-14.139z"
                                    />
                                    <path
                                        d="m65.283 49.291c2.721 0 5.432-1.104 7.406-3.275 3.715-4.086 3.414-10.411-.673-14.126-4.086-3.715-10.411-3.413-14.126.673l-.005.005c-3.715 4.086-3.411 10.408.675 14.123 1.916 1.742 4.323 2.6 6.723 2.6z"
                                    />
                                </g>
                            </g>
                        </svg>
                    </a>
                    <h3 class="why-us__container--header">تنوع محصولات ما</h3>
                    <p class="why-us__container--text">ما به ذائقه شما احترام میگذاریم شما میتوانید انواع لاین ها را از ورگار کافی تهیه کنید</p>
                </div>
            </section>
            <section class="contact" id="contact">
                <div class="heading-secondary why-us__heading"><h2 class="heading-secondary--text">تماس با ما</h2></div>
                <div class="contact-form" id="form">
                    <div class="contact-form__container">
                        <div class="contact-form__container--right">
                            <form action="/resourses/form.php" method="post" title="post" class="form">
                                <?php 
                                    if($_GET['success'] == 1){
                                        echo "<div class=\"sent success\">با تشکر ! ایمیل شما ارسال شد </div>";
                                    }
                                    if($_GET['success'] == -1){
                                        echo "<div class=\"sent fail\">مشکلی پیش اومده! دوباره امتحان کن</div>";
                                    }      
                                ?>
                                <div class="form__input-countainer">
                                    <input type="text" name="name"  id="Name" placeholder="Name" class="form__input-countainer--input form__input-countainer--input--1" /> <span class="form__input-countainer--icon form__input-countainer--icon--1"></span>
                                </div>
                                <div class="form__input-countainer">
                                    <input type="number" name="number" id="number" placeholder="number" class="form__input-countainer--input form__input-countainer--input--2" />
                                    <span class="form__input-countainer--icon form__input-countainer--icon--2"></span>
                                </div>
                                <div class="form__input-countainer">
                                    <input onchange="submitForm(0)"  name="email" id="email" placeholder="Email" class="form__input-countainer--input form__input-countainer--input--4 email-validation" />
                                    <span class="form__input-countainer--icon form__input-countainer--icon--4"></span>
                                </div>
                                <div class="form__textarea-container">
                                    <span id="message" class="form__input-countainer--icon form__input-countainer--icon--3"></span>
                                    <textarea name="textarea"  id="textarea" cols="30" rows="10" class="form__textarea-container--textarea" placeholder="message"></textarea>
                                </div>
                                <button type="submit" class="form__btn">ارسال</button>
                            </form>
                        </div>
                        <div class="contact-form__container--left">
                            <div class="address">
                                <div class="addressia">
                                    <h2 class="address--text">آدرس</h2>
                                    <p class="address__address--text">بازار 15 خرداد-تقاطع پله شیرازی و نوروزخان-پاساژ صالحی-پلاک 61</p>
                                </div>
                                <div class="address__location">
                                    <h2 class="address--text">مارو پیدا کن</h2>
                                    <div class="address__location--map">
                                        
										<iframe
												id="iframe"
												src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3241.012639069795!2d51.42311211561967!3d35.676690780195365!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3f8e01f0ce27b095%3A0x1e3926183d6e9f32!2sTehran%20Province%2C%20Tehran%2C%20District%2012%2C%20Panzdah-e-Khordad%20St%2C%20Iran!5e0!3m2!1sen!2s!4v1622463210603!5m2!1sen!2s"
												style="border:0;"
												allowfullscreen="1"
												>
										</iframe>
                                    </div>
                                    <div class="address-cal">
                                        <ul>
                                            <li>
                                                <a href="tel:00989925402149">
                                                    واحد فروش: 2149 540 0992
                                                    <svg
                                                        class="nav__icons--image-dark"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                        version="1.1"
                                                        x="0px"
                                            ...
                                            <li>
                                                <a href="tel:00989925402148">
                                                    واحد فنی: 2148 540 0992
                                                    <svg
                                                        class="nav__icons--image-dark"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <div class="address__location--icons">
                                        <a href="https://wa.me/send?phone=989925402149&text=سلام . من نیاز به کمک دارم" target="_blank">
                                            <svg class="nav__icons--image-dark wp-icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                <path
                                                    d="m17.507 14.307-.009.075c-2.199-1.096-2.429-1.242-2.713-.816-.197.295-.771.964-.944 1.162-.175.195-.349.21-.646.075-.3-.15-1.263-.465-2.403-1.485-.888-.795-1.484-1.77-1.66-2.07-.293-.506.32-.578.878-1.634.1-.21.049-.375-.025-.524-.075-.15-.672-1.62-.922-2.206-.24-.584-.487-.51-.672-.51-.576-.05-.997-.042-1.368.344-1.614 1.774-1.207 3.604.174 5.55 2.714 3.552 4.16 4.206 6.804 5.114.714.227 1.365.195 1.88.121.574-.091 1.767-.721 2.016-1.426.255-.705.255-1.29.18-1.425-.074-.135-.27-.21-.57-.345z"
                                                />
                                                <path
                                        ...
                                        <a href="https://goo.gl/maps/gakEwhJb6p2c1cGeA" target="_blank" class="address__location--icons--location">
                                            <svg
                                                class="nav__icons--image-dark loc-icon address__location--icons--location--icon"
                                                version="1.1"
                                                x="0px"
                                                y="0px"
                                        ...
                                        <a href="https://t.me/vargaarcoffee" target="_blank">
                                            <svg class="nav__icons--image-dark tele-icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                <path
                                                    d="m9.417 15.181-.397 5.584c.568 0 .814-.244 1.109-.537l2.663-2.545 5.518 4.041c1.012.564 1.725.267 1.998-.931l3.622-16.972.001-.001c.321-1.496-.541-2.081-1.527-1.714l-21.29 8.151c-1.453.564-1.431 1.374-.247 1.741l5.443 1.693 12.643-7.911c.595-.394 1.136-.176.691.218z"
                                                />
                                            </svg>
                                        </a>
                                        <a href="http://www.instagram.com/vargaarcoffee" target="_blank">
                                            <svg class="nav__icons--image-dark insta-icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                <path
            ...
            <section class="feedback">
                <div class="heading-secondary feedback__text"><h2 class="heading-secondary--text">نظر کاربران</h2></div>
                <div class="feedback-container">
                    <div class="feedback-box">
                        <div class="box-content"><p class="content-paragraph">سلام و خسته نباشید بنده واقعا لذت بردم از آشنایی با شما کیفیت بسیار خوب تحویل سریع و از همه مهمتر راهنمایی و مشاوره عالی ای که داشتید واقعا سپاس گذارم.</p></div>
                        <div class="box-img">
                            <img src="resourses/css/img/avatar-new.jpg" alt="avatar image" />
                            <h2 class="content-head">سوگند</h2>
                        </div>
                    </div>
                    <div class="feedback-box">
                        <div class="box-content">
                            <p class="content-paragraph">
                                - من قهوه های شما رو امتحان کردم . واقعا عالی بود مخصوصاً لاین 60|40 که فوق العاده بود برای اسپرسو مرسی از اینکه راهنماییم کردید توی خریدم واقعا تونستم خرید لذت بخشی داشته باشم مرسی از تیم ورگار کافی
                            </p>
                        </div>
                        <div class="box-img">
                            <img src="resourses/css/img/avatar-new.jpg" alt="avatar image" />
                            <h2 class="content-head">رادمهر</h2>
                        </div>
                    </div>
                    <div class="feedback-box">
                        <div class="box-content">
                            <p class="content-paragraph">
                                با سلام من کافه دارم و به تازگی با شما و تیم فوق العادتون آشنا شدم همه همکاران توی این صنف میدونن که 3تا مطلب برای ما خیلی مهمه یک کیفیت دو تداوم کیفیت سه قیمت که واقعا میتونم به جرعت بگم توی این چند سالی که
                                دارم کار میکنم شما بهترین بودید هرچی بگم بازم کم گفتم
                            </p>
                        </div>
                        <div class="box-img">
                            <img src="resourses/css/img/avatar-new.jpg" alt="avatar image" />
                            <h2 class="content-head">سامان</h2>
                        </div>
                    </div>
                </div>
                <a class="more feedback__btn" href="#contact">
                    <div class="mores"><div class="more__arrow">تجربه شما چطور بود؟</div></div>
                </a>
            </section>
            <footer>
                <div class="footer">
                    <div class="left-foot foot">
                        <h2>آدرس</h2>
                        <p>بازار 15 خرداد-تقاطع پله شیرازی و نوروزخان-پاساژ صالحی-پلاک 61</p>
                        <div class="left-foot--loc">
                            <a href="https://goo.gl/maps/gakEwhJb6p2c1cGeA" class="address__location--icons--location footer-location">
                                <svg
                                    class="nav__icons--image-dark footer-loc"
                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                    version="1.1"
                                    x="0px"
                                    y="0px"
                    ...
                    <div class="center-foot foot">
                        <h2>ارتباطات</h2>
                        <ul>
                            <li><a href="products.html">محصولات</a></li>
                        </ul>
                        <ul>
                            <li><a href="#why-us">درباره ما</a></li>
                        </ul>
                        <ul>
                    ...
                    <div class="right-foot foot">
                        ...
                        <ul>
                            <li>
                                <a class="demo-products__icon" href="tel:00989925402149">
                                    واحد فروش: 2149 540 0992
                                    <svg
                                        class="top-head--icon foot-icon"
                                        xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                        version="1.1"
                                        x="0px"
                        ...
                        <ul>
                            <li>
                                <a class="demo-products__icon" href="tel:00989925402148">
                                    واحد فنی: 2148 540 0992
                                    <svg
                                        class="top-head--icon foot-icon"
                                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        <ul>
                            <li>
                                <a class="demo-products__icon" href="mailto:vargaarcoffee@gmail.com ">
                                    vargaarcoffee@gmail.com
                                    <svg class="top-head--icon foot-icon">
                ...
                <div class="footer-copy"><p>&copy;all rights belong to zartosht company</p></div>
            </footer>
            <div id="popup" class="popup">
                <div class="popup-leave"><span id="popup-leave">&#x274C;</span></div>
                <div class="popup__container">
                    <div class="right">
                        <div class="popup-img"><img src="resourses/css/img/coffees/turkish-final.jpg" alt="cofee bag" /></div>
                    </div>
                    <div class="left">
                        <form action="order.php" method="post" class="form">
                            <div class="form__text"><h3>ثبت سفارش</h3></div>
                            <div class="form__input-countainer">
                                <input type="text" id="name-popup" name="name-popup" placeholder="Name" class="form__input-countainer--input form__input-countainer--input--1" required />
                                <span class="form__input-countainer--icon form__input-countainer--icon--1"></span>
                            </div>
                            <div class="form__input-countainer">
                                <input type="number" id="number-popup" name="number-popup" placeholder="number" class="form__input-countainer--input form__input-countainer--input--2" required />
                                <span class="form__input-countainer--icon form__input-countainer--icon--2"></span>
                            </div>
                            <div class="form__input-countainer">
                                <input onchange="submitForm(1)"  id="email-popup" name="email-popup" placeholder="email" class="form__input-countainer--input form__input-countainer--input--2 email-validation" required />
                                <span class="form__input-countainer--icon form__input-countainer--icon--2"></span>
                            </div>
                            <div class="choose-coffee">
                                <select class="coffee-type" id="coffee-type" name="coffee-type">
                                    <option value="Kenesht">Kenesht</option>
                                    <option value="Youtab">Youtab</option>
                                    <option value="Sargon">Sargon</option>
                                    <option value="Vardan">Vardan</option>
                                    <option value="Rira">Rira</option>
                                    <option value="Turkish">Turkish</option>
                                    
                                </select>
                                <select class="coffee-weight" id="weight" name="coffee-weight">
                                    <option value="5">5 kg</option>
                                    <option value="1">1 kg</option>
                                    <option value=".5">500 g</option>
                                    <option value=".2">200 g</option>
                                </select>
                                <input type="number" min="1" max="9"  name="coffee-numbers" id="coffee-numbers" class="coffee-numbers" placeholder="تعداد" required />
                            </div>
                            <button class="form__btn popup-btn"><span>ثبت</span></button>
                        </form>
                    </div>
                </div>
            </div>
